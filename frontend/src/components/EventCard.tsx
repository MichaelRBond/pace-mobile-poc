...
export const EventCard = ({ communication, onDelete, getRSVP, rsvpCount }: Props) => (
    <Card>
        <div className={"event-title"}>
            ...
            {communication.event != null && <div style={{minWidth: "fix-content"}}>
            ...
            <div className="event-title-spacer" />
            <div style={{minWidth: "fix-content"}}>
            <Tag
                intent={Intent.NONE}>{`Expires: ${new Date(communication.expiration_date * 1000).toDateString()}`}
            </Tag>
            </div>
        </div>
